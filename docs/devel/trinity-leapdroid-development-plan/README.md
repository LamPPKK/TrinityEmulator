...
5. [Phase 3 — graphics compatibility and performance](phase-3-graphics.md)
6. [Phase 4 — seamless application windows](phase-4-seamless-windows.md)
7. [Phase 4A — input, cursor, and controllers](phase-4a-input-cursor-controller.md)
8. [Phase 4B — native app experience and display profiles](phase-4b-native-app-experience-display-profiles.md)
9. [Phase 5 — native host integration](phase-5-host-integration.md)
10. [Phase 5A — clipboard and notifications](phase-5a-clipboard-notifications.md)
11. [Phase 6 — security, updates, compliance, and licensing](phase-6-security-update-compliance.md)
12. [Phase 6A — zero telemetry and layered sandboxing](phase-6a-zero-telemetry-sandbox.md)
13. [Phase 7 — hardening, beta, and general availability](phase-7-hardening-release.md)
